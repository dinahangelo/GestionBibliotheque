 ...
 * @author solofonirina
 */
public class ListeEleve extends javax.swing.JDialog {
    GestionEleve ge = new GestionEleve();
    public static String numeroMatricule;

    /**
     * Creates new form ListeEleve
     */
    public ListeEleve(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        listEleve();
    ...
    public void listEleve(){
        ...
        table.addColumn("Numéro matricule");
        table.addColumn("Nom");
        tableEleve.setModel(table);
        TableColumnModel colonne = tableEleve.getColumnModel();
        colonne.getColumn(0).setPreferredWidth(50);
        colonne.getColumn(1).setPreferredWidth(250);
        for(Eleve e : ge.list()){
            Object[] line = {e.getNumeroMatricule(), e.getNom()};
            table.addRow(line);
        }
    }
    ...
    public void search(){
        ...
        colonne.getColumn(0).setPreferredWidth(50);
        colonne.getColumn(1).setPreferredWidth(250);
        for(Eleve e : ge.search(txtSearch.getText())){
            Object[] line = {e.getNumeroMatricule(), e.getNom()};
            table.addRow(line);
        }
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        new NouveauEleve(null, rootPaneCheckingEnabled).setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        int n = tableEleve.getSelectedRow();
        String numero = (String) tableEleve.getValueAt(n, 0);
        String nom = (String) tableEleve.getValueAt(n, 1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        int n = tableEleve.getSelectedRow();
        numeroMatricule = (String) tableEleve.getValueAt(n, 0);
        new ModifierEleve(null, rootPaneCheckingEnabled).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListeEleve dialog = new ListeEleve(new javax.swing.JFrame(), true);
