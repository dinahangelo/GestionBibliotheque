 ...
 * @author solofonirina
 */
public class ListeProfesseur extends javax.swing.JDialog {
    GestionProfesseur gp = new GestionProfesseur();
    public static String codeProfesseur;

    /**
     * Creates new form ListeEleve
     */
    public ListeProfesseur(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        listProfesseur();
    ...
    public void listProfesseur(){
        DefaultTableModel table = new DefaultTableModel();
        table.addColumn("Code");
        table.addColumn("Nom");
        tableProfesseur.setModel(table);
        TableColumnModel colonne = tableProfesseur.getColumnModel();
        colonne.getColumn(0).setPreferredWidth(50);
        colonne.getColumn(1).setPreferredWidth(250);
        for(Professeur p: gp.list()){
            Object[] line = {p.getCodeProfesseur(), p.getNomProfesseur()};
            table.addRow(line);
        }
    }
    ...
    public void search(){
        ...
        colonne.getColumn(0).setPreferredWidth(50);
        colonne.getColumn(1).setPreferredWidth(250);
        for(Professeur p: gp.search(txtSearch.getText())){
            Object[] line = {p.getCodeProfesseur(), p.getNomProfesseur()};
            table.addRow(line);
        }
    }
    ...
    private void initComponents() {
        ...
        tableProfesseur.setAlignmentY(0.0F);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        new NouveauProfesseur(null, rootPaneCheckingEnabled).setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        int n = tableProfesseur.getSelectedRow();
        String code = (String) tableProfesseur.getValueAt(n, 0);
        String nom = (String) tableProfesseur.getValueAt(n, 1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        int n = tableProfesseur.getSelectedRow();
        codeProfesseur = (String) tableProfesseur.getValueAt(n, 0);
        new ModifierProfesseur(null, rootPaneCheckingEnabled).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListeProfesseur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListeProfesseur dialog = new ListeProfesseur(new javax.swing.JFrame(), true);
