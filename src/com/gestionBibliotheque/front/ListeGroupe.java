 ...
 * @author solofonirina
 */
public class ListeGroupe extends javax.swing.JDialog {
    GestionGroupe gg = new GestionGroupe();
    GestionEtagere ge = new GestionEtagere();
    public static String idGroupe;

    /**
     * Creates new form ListeGroupe
     */
    public ListeGroupe(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void listEtagere(){
        ...
        table.addColumn("PfEtagere");
        table.addColumn("Etagère");
        tableGroupe.setModel(table);
        TableColumnModel colonne = tableGroupe.getColumnModel();
        colonne.getColumn(0).setPreferredWidth(50);
        colonne.getColumn(1).setPreferredWidth(200);
        for(Groupe g : gg.list()){
            Object[] line = {g.getIdGroupe(),g.getLibelleGroupe(),g.getPfEtagere(),ge.getEtagere(g.getIdEtagere())};
            table.addRow(line);
        }
    }
    ...
    public void search(){
        ...
        colonne.getColumn(0).setPreferredWidth(50);
        colonne.getColumn(1).setPreferredWidth(200);
        for(Groupe g : gg.search(txtSearch.getText())){
            Object[] line = {g.getIdGroupe(),g.getLibelleGroupe(),g.getPfEtagere(),ge.getEtagere(g.getIdEtagere())};
            table.addRow(line);
        }
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(487, 544));
        setResizable(false);
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(487, 544));
        ...
        jLabel1.setText("Groupe(s)");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/gestionBibliotheque/image/Search_20px_1.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        new NouveauGroupe(null, rootPaneCheckingEnabled).setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        int n = tableGroupe.getSelectedRow();
        idGroupe = (String) tableGroupe.getValueAt(n, 0);
        new ModifierGroupe(null, rootPaneCheckingEnabled).setVisible(true);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        int n = tableGroupe.getSelectedRow();
        String idGroupe = (String) tableGroupe.getValueAt(n, 0);
        String libelle = (String) tableGroupe.getValueAt(n, 1);
        if(JOptionPane.showConfirmDialog(null, "Vous êtes en train de supprimer "+libelle+" de la liste. Voulez-vous continuer? ") == JOptionPane.YES_NO_OPTION){
            try {
                gg.delete(idGroupe);
            } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListeGroupe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListeGroupe dialog = new ListeGroupe(new javax.swing.JFrame(), true);
